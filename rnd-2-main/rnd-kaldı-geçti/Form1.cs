...
namespace rnd_kaldı_geçti
{
    public partial class Form1 : Form
    {
        ...
        private void btnDurum_Click_1(object sender, EventArgs e)
        {
int kaldi = 0, gecti = 0, tesekkur = 0, takdir = 0;
            for (int i = 0; i < lbNotlar.Items.Count; i++)
            {
                ...
                lblGecen.Text = "Düz geçen öğrenci sayısı: " + Convert.ToString(gecti);
